...
export const Experience: React.FC<Props> = ({resumeExperience, resumeBasicInfo}) => {
  const [sectionName, setSectionName] = useState('')
  const [work, setWork] = useState<React.ReactElement[]>([])

  useEffect(() => {
    if (resumeExperience && resumeBasicInfo) {
      setSectionName(resumeBasicInfo.section_name.experience)
      setWork(resumeExperience.map(function (work, i) {
